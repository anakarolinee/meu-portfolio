...
const Hero = () => {
  ...
  return <div className="relative min-h-screen mb-4 overflow-hidden">
      ...
      <div className="w-full ">
        <div className={`flex flex-col py-48 mt-24  items-center lg:items-start pb-8 transition-all duration-1000 transform ${isVisible}`}>
          ...
          <div className="flex space-x-2 mt-4">
            <div className="w-32 h-1 bg-gradient-to-r from-gray-500 to-purple-600 rounded-full animate-pulse"></div>
            <div className="w-8 h-1 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full animate-pulse animation-delay-200"></div>
            <div className="w-4 h-1 bg-gradient-to-r from-indigo-500 to-purple-800 rounded-full animate-pulse animation-delay-400"></div>
          </div>
        </div>

        <div className="mt-12 ">
          <div className="transform transition-all bg-gray-100 rounded-b-full rounded-r-full  duration-700 "><SobreMim /></div>
